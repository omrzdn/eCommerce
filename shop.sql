...
--
-- Host: localhost
-- Generation Time: Jun 21, 2021 at 01:28 AM
...
INSERT INTO `items` (`itemID`, `Name`, `Description`, `Price`, `Add_Date`, `Country_Made`, `Image`, `Status`, `Rating`, `Approve`, `catID`, `Member_ID`, `tags`) VALUES
...
(25, 'Osama', 'OMAR ZIDAN OMAR ZIDAN ZIDAN', '100', '2016-06-17', 'Egypt', '', '3', 0, 1, 10, 30, ''),
...
(3, 'omrzdn', 'ff075d214040a5d1fa56101542a4aaca51f73f3e', 'asd@AS.XCOM', 'OMAR Zidan', 1, 0, 0, '2021-06-16', ''),
